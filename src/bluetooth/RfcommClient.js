...
class RfcommClient extends EventEmitter {
    constructor(options = {}) {
        super();
        this.bridgeScript = options.bridgeScript || null;
    ...
    // Lists paired classic-Bluetooth devices (name + MAC) via PnP. The MAC is
    // pulled from the instance ID (BTHENUM\DEV_AABBCCDDEEFF) or from the
    // DEVPKEY_Bluetooth_DeviceAddress property as a fallback.
